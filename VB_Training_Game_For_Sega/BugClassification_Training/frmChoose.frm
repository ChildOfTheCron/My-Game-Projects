...
'Form is now used to display Help in the datasheet.
...
"To add additional bugs add new entries at the bottom of the datasheet. To a bug delete the WHOLE row of the bug." _

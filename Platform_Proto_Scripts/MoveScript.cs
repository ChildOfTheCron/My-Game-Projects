...
public class MoveScript : MonoBehaviour {
	...
	void Start () {
		...
		leftTexture = Resources.Load ("Textures/Slug", typeof(Texture)) as Texture;
	...
	void Update () {
		...
		if(leftBounds == false)
		{
			if (Input.GetKey ("a")){
				...
				if (GameObject.Find("Player").gameObject.GetComponent<Renderer>().material.GetTexture("_MainTex") == leftTexture)
